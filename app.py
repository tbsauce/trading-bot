...
# Donchian Channel
data_donchian_channels = bot.get_donchian_channel(480, symbol, time_frame, start_date, end_date, feed)

# Volume Bars
data_volume = bot.get_volume(data)

# Volume MA
data_vma = bot.get_volume_moving_average(50, symbol, time_frame, start_date, end_date, feed)
